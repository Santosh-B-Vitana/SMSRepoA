...
import { 
  ...
  Shield, Users, Clock, AlertTriangle, GraduationCap
} from 'lucide-react';
...
export default function Login() {
  ...
  // Redirect if already authenticated — enforce portal type restriction
  useEffect(() => {
  ...
  const demoUsers = [
    { email: 'admin@vitanaschools.edu', role: 'Admin', password: 'AdminDemo2026!', name: 'Admin User', portal: 'admin' },
