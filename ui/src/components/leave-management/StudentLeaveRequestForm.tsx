...
export function StudentLeaveRequestForm({ studentId, studentName, onSuccess, onClose }: StudentLeaveRequestFormProps) {
  ...
  const onSubmit = async (data: any) => {
    try {
      ...
      const leaveTypes = await leaveManagementApi.getLeaveTypes("Student");
