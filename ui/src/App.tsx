            ...
            <AuthProvider>
              ...
              <Router>
                ...
                <Routes>
                  ...
                  <Route path="/fees/collect/:studentId" element={<ProtectedRoute allowedRoles={['admin','super_admin','staff']}><Layout><ModuleGuard module="fees"><StudentFeePaymentPage /></ModuleGuard></Layout></ProtectedRoute>} />
