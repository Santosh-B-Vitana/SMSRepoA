...
- Name: academic-setup.spec.ts >> Phase 1 — Academic Year setup >> 1.3 — Year 2026-2027 appears in the table
- Location: e2e\academic-setup.spec.ts:211:3
...
Call log:
  - waiting for getByRole('tab', { name: /Academic Years/i }).first()
