...
- Name: staff-attendance-leave-deduction.spec.ts >> Phase 6: Staff UI — My Leaves balance is deducted >> My Leaves page loads and shows leave balance
- Location: e2e\staff-attendance-leave-deduction.spec.ts:554:3
