...
- Name: staff-attendance-leave-deduction.spec.ts >> Phase 4: API — verify attendance and leave deduction >> GET attendance for Amit Kapoor today shows status=leave with correct leave type
- Location: e2e\staff-attendance-leave-deduction.spec.ts:392:3
...
Expected: "823740ed-d732-4319-9063-d473382d02e0"
Received: null
```
