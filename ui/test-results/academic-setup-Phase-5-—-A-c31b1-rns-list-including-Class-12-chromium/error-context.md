...
- Name: academic-setup.spec.ts >> Phase 5 — API smoke tests >> 5.2 — GET /academics/classes returns list including Class 12
- Location: e2e\academic-setup.spec.ts:559:3
