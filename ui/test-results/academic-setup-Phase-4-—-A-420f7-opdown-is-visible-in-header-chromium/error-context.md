...
- Name: academic-setup.spec.ts >> Phase 4 — Academic year nav dropdown >> 4.1 — Academic year dropdown is visible in header
- Location: e2e\academic-setup.spec.ts:466:3
