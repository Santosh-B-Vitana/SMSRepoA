...
- Name: academic-setup.spec.ts >> Phase 4 — Academic year nav dropdown >> 4.2 — Selecting a year from the dropdown updates the display
- Location: e2e\academic-setup.spec.ts:475:3
