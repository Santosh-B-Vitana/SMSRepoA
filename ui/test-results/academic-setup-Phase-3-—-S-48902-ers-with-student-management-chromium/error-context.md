...
- Name: academic-setup.spec.ts >> Phase 3 — Section management >> 3.5 — Section A detail page renders with student management
- Location: e2e\academic-setup.spec.ts:434:3
